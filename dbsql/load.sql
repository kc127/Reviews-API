...
-- LOAD DATA LOCAL INFILE '/Users/kanchanchauhan/Documents/sei/sdc/Reviews/data/characteristic_reviews.csv' INTO TABLE characteristics_reviews FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\n' IGNORE 1 ROWS (@col1,@col2,@col3, @col4) SET id=@col1, characteristics_id=@col2, reviews_id=@col3, characteristics_value=@col4;
